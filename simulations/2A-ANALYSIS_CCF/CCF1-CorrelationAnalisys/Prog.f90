...
integer,parameter:: Window=150 !The actual window used, should change this value 

!Parameters For read File:
integer:: Run=1
real(8),parameter:: Threshold=0.3300
integer,parameter:: startx=1
integer,parameter:: starty=151
...
integer,parameter:: maxdist=40 !Avoid Computing over distances larger than maxdist
...
call system ('mkdir -p ResultsCorrelShuffle')

open(103,file='../../1-Dynamics_generator/Shuffle/ResultsState/StateRun' &
...
open(203,file='ResultsCorrelShuffle/CorrelRun' // trim(adjustl(file_name))// '-Tr0.'  &
